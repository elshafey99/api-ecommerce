<x-createcomponent title="{{ __('dashboard.create-category') }}" class="btn-success">
    <div class="row">
        ...
        <div class="col-md-6 mb-3">
            ...
            <textarea class="form-control @error('description_ar') is-invalid @enderror" wire:model="description_ar"
                placeholder="{{ __('dashboard.description-ar') }}" rows="3" dir="rtl"></textarea>
        ...
        <div class="col-md-6 mb-3">
            ...
            <textarea class="form-control @error('description_en') is-invalid @enderror" wire:model="description_en"
                placeholder="{{ __('dashboard.description-en') }}" rows="3" dir="ltr"></textarea>
        ...
        <div class="col-md-6 mb-3">
            <label class="form-label">{{ __('dashboard.parent') }}</label>
            <select class="form-select @error('parent_id') is-invalid @enderror" wire:model="parent_id">
                <option value="">{{ __('dashboard.no-parent') }}</option>
