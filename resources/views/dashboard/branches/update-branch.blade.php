<x-updatecomponent title="{{ __('dashboard.update-branch') }}">
    <div class="row">
        {{-- Name Fields --}}
        ...
        <div class="col-12 mb-3">
            ...
            <div id="updateMap" style="height: 300px; border-radius: 8px; border: 1px solid #ddd;"></div>
        ...
        <div class="col-md-6 mb-3">
            ...
            <input type="number" step="0.00000001" class="form-control @error('latitude') is-invalid @enderror"
                wire:model="latitude" id="updateLatitude" placeholder="30.0444" readonly>
            @error('latitude')
                <div class="invalid-feedback">{{ $message }}</div>
            @enderror
        </div>
        ...
        <div class="col-md-6 mb-3">
            ...
            <input type="number" step="0.00000001" class="form-control @error('longitude') is-invalid @enderror"
                wire:model="longitude" id="updateLongitude" placeholder="31.2357" readonly>
            @error('longitude')
                <div class="invalid-feedback">{{ $message }}</div>
            @enderror
        </div>
        ...
        <div class="col-md-4 mb-3">
            ...
            <div class="form-check form-switch mt-2">
                <input class="form-check-input" type="checkbox" wire:model="is_main" id="mainSwitchUpdate">
                <label class="form-check-label" for="mainSwitchUpdate">
