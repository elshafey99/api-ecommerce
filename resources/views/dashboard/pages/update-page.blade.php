<x-updatecomponent title="{{ __('dashboard.update-page') }}" size="modal-xl">
    <div class="row">
        {{-- Title AR --}}
        ...
        <div class="col-md-4 mb-3">
            ...
            <div class="form-check form-switch mt-2">
                <input class="form-check-input" type="checkbox" wire:model="is_active" id="updateStatusSwitch">
                <label class="form-check-label" for="updateStatusSwitch">
        ...
        <div class="col-md-12 mb-3" wire:ignore>
            ...
            <textarea id="update_content_ar" class="form-control @error('content_ar') is-invalid @enderror" dir="rtl"
                rows="6"></textarea>
            @error('content_ar')
                <div class="invalid-feedback">{{ $message }}</div>
            @enderror
        ...
        <div class="col-md-12 mb-3" wire:ignore>
            ...
            <textarea id="update_content_en" class="form-control @error('content_en') is-invalid @enderror" dir="ltr"
                rows="6"></textarea>
            @error('content_en')
                <div class="invalid-feedback">{{ $message }}</div>
            @enderror
