<x-createcomponent title="{{ __('dashboard.create-banner') }}" class="btn-success" size="modal-xl">
    <div class="row">
        {{-- Image Upload --}}
        <div class="col-md-6 mb-3">
            <label class="form-label">{{ __('dashboard.image') }} <span class="text-danger">*</span></label>
