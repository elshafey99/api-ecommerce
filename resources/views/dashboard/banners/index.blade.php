        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h4 class="card-title mb-0">{{ __('dashboard.banners') }}</h4>
                    <button type="button" class="btn btn-primary waves-effect" data-bs-toggle="modal"
                        data-bs-target="#createModal">
                        <i data-feather='plus'></i> {{ __('dashboard.create-banner') }}
                    </button>
                </div>
                @livewire('dashboard.banners.banners')
            </div>
        </div>
    </div>

    @livewire('dashboard.banners.add-banner')
    @livewire('dashboard.banners.update-banner')
@endsection
