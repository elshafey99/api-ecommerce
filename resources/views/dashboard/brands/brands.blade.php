        ...
        <table class="table table-hover table-bordered">
            <thead class="table-light">
                <tr>
                    ...
                    <th class="align-middle" style="width: 15%;">{{ __('dashboard.slug') }}</th>
                    <th class="text-center align-middle" style="width: 10%;">{{ __('dashboard.products_count') }}</th>
            ...
            <tbody>
                @if ($data->count() > 0)
                    @foreach ($data as $item)
                        <tr wire:key="brand-{{ $item->id }}" style="height: 80px;">
