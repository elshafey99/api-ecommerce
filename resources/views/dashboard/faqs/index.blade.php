@extends('dashboard.master', ['title' => __('dashboard.faqs')])
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h4 class="card-title mb-0">{{ __('dashboard.faqs') }}</h4>
                    <button type="button" class="btn btn-primary waves-effect" data-bs-toggle="modal"
                        data-bs-target="#createModal">
                        <i data-feather='plus'></i> {{ __('dashboard.create-faq') }}
                    </button>
                </div>
                @livewire('dashboard.faqs.faqs')
            </div>
        </div>
    </div>

    @livewire('dashboard.faqs.add-faq')
    @livewire('dashboard.faqs.update-faq')
@endsection
